...
- **DMV Registration:** You can fill out forms for License Plates, Driver's Licenses, and IDs at the [Grimlocke DMV](https://townofgrimlocke.com/dmv).
  - Fees: 
    - \$15 Linden for a generic plate. 
    - \$30 Linden for custom plates.
    - \$30 Linden for Drivers License or ID.
...
- **Paying Fines:** Fine payments are strictly for Roleplay purposes. If you prefer not to Roleplay the entire court or police interaction, you may post a quick emote in the local RP group stating how it was handled (e.g., _mailed it in, paid online, dropped it off at village hall_). Please send a copy of this record or a Discord notification to the Sheriff or Mayors.
